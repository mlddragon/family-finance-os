...
def create_app(
    *,
    ...
    resolved_data_root = (data_root or _default_data_root()).expanduser().resolve()
    ...
    def status_payload() -> Dict[str, Any]:
        return {
            ...
            "bind_host": bind_host,
            "data_root": {
                "path": str(resolved_data_root),
                "exists": resolved_data_root.exists(),
            },
            "database": _database_status(resolved_data_root),
        }
